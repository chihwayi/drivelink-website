...
export class Faq {
  faqs: FAQ[] = [
    ...
    {
      id: 1,
      question: "Does DriveLink Auto's export services include pre-owned cars?",
      answer: "Yes, DriveLink Auto's export services include pre-owned cars. We handle the export of both new and pre-owned vehicles to various African countries, ensuring all necessary documentation and compliance requirements are met.",
      category: 'export',
      isOpen: false
    },
    {
      id: 2,
      question: "Does DriveLink Auto take care of all the paperwork and compliance matters related to vehicle exports?",
      answer: "Yes, at DriveLink Auto we take care of all the paperwork and compliance matters. This includes obtaining export permits, handling registration documents, police clearance certificates, bills of lading, and commercial invoices.",
      category: 'export',
      isOpen: false
    },
    {
    ...
    {
      id: 6,
      question: "Why should I choose DriveLink Auto?",
      answer: "Choose DriveLink Auto for our extensive experience in African vehicle exports, comprehensive service handling, competitive pricing, reliable shipping partners, and excellent customer support throughout the export process.",
      category: 'export',
      isOpen: false
    },
    // General Q&A
    {
      ...
      answer: "You will need the vehicle's registration documents, proof of ownership, an export permit, and a police clearance certificate. Additionally, you may need a bill of lading and a commercial invoice. At DriveLink Auto we take care of all the paperwork.",
      category: 'general',
      isOpen: false
    },
    {
