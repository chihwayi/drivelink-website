...
export class Gallery implements OnInit, OnDestroy {
  ...
  galleryItems: GalleryItem[] = [
    {
      id: 1,
      title: 'BMW X5 Delivery',
      description: 'Premium SUV delivered to satisfied client in Johannesburg',
      imagePath: 'assets/images/gallery/delivery-1.jpg',
      category: 'luxury',
    ...
    {
      id: 2,
      title: 'Mercedes C-Class Handover',
      description: 'Elegant sedan successfully imported and delivered',
      imagePath: 'assets/images/gallery/delivery-2.jpg',
      category: 'sedan',
      clientName: 'Ms. Smith',
    ...
    {
      id: 3,
      title: 'Toyota Hilux Collection',
      description: 'Reliable pickup truck ready for business operations',
      imagePath: 'assets/images/gallery/delivery-3.jpg',
      category: 'truck',
    ...
    {
      id: 4,
      title: 'Audi Q7 Premium Delivery',
      description: 'Luxury SUV with full documentation and premium service',
      imagePath: 'assets/images/gallery/delivery-4.jpg',
      category: 'luxury',
    ...
    },
    {
      ...
      imagePath: 'assets/images/gallery/delivery-5.jpg',
      category: 'truck',
    ...
    },
    {
      ...
      imagePath: 'assets/images/gallery/delivery-6.jpg',
      category: 'sedan',
      clientName: 'Mr. Patel',
